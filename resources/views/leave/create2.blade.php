...
@section('content')
                ...
                <form action="{{ url('leave') }}" method="post" id="leave_form">
                            ...
                            <table class="table table-striped" id="leave_credits_table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td
                                            style=" text-align:  center; font-weight:  bold; color:  #0000FF; background-color: yellow;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group float-right">
                                <input type="text" value="{{ date('m/d/Y') }}" name="date_filed" class="form-control"
                                    placeholder="Date Filed" readonly autocomplete="off">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <input type="text" id="txtPhone" name="position" class="form-control"
                                    placeholder="Position" value="{{ Auth::user()->position_name }}"
                                    {{ Auth::user()->isAdmin() ? '' : 'readonly' }}>
                            </div>
                            <!--
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <input type="text" name="department" class="form-control" placeholder="Dept/Section"
                                    value="{{ Auth::user()->team_name }}" {{ Auth::user()->isAdmin() ? '' : 'readonly' }}>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <input id="main_date_picker" type="text" name="leave_date[]"
                                    class="form-control _datesFiled" placeholder="Leave Date" autocomplete="off">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <strong>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <input type="text" name="number_of_days" value="1"
                                    class="form-control _numOfDaysField" list="leave_days" placeholder="No. of Days"
                    ...
                    <div class="row">
                        <div class="col-md-12"
                            style="border-top: 1px solid rgba(0,0,0,.125); padding-top: 15px; margin-top: 25px">
                            <strong>
                                <p>Type of Leave:</p>
                            </strong>
                        </div>
                    ...
                    <div class="row" style="padding-bottom: 25px; margin-bottom: 25px;">
                            ...
                            ?>
                                        <li class="list-group-item{{ $lv->status == 1 ? ' _planned' : ' _unplanned' }}">
                                            <label class="switch float-left">
                                                <input type="checkbox" name="leave_type_id" value="{{ $lv->id }}"
                                                    id="progress{{ $lv->id }}" tabIndex="1" class="primary"
                                                    onClick="ckChange(this)" required>
                        ...
                        <div class="col-md-9">
                            <div class="report-date-box" style="padding-top: 25%">
                                ...
                                <input type="text" name="report_date" class="datepicker" placeholder="date"
                                    autocomplete="off">
                                If i fail to do so on the said date without any justifiable cause.
                                I can considered to have abandoned my employment. I understand that any misrepresentation I
    ...
    <div id="row_~~id~~"  class="row">
        <div class="col-md-4">
            ...
            <div class="form-group">
                <input id="date_picker_~~id~~"  type="text" name="leave_date[]" class="form-control _datesFiled" placeholder="Leave Date" autocomplete="off">
            </div> 
        </div>
        <div class="col-md-2">

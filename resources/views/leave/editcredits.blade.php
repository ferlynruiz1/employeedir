                            ...
                            <form method="POST" action="{{ url('leave/credits') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" disabled
                                        value="{{ number_format($credits->current_credit, 2) }}">
                                </div>
                                <div class="form-group">
                                ...
                                <div style="display: flex; gap: 1rem;">
                                    <div class="form-group">
                                        <label for="pto_forwarded">{{ now()->subYear()->format('Y') }} PTO
                                            Forwarded</label>
                                        <input type="number" name="pto_forwarded" id="pto_forwarded" min="0"
                                            step="0.01" value="0" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label for="monthly_accrual">{{ now()->format('Y') }} Monthly Accrual</label>
                                        <input type="number" name="monthly_accrual" id="monthly_accrual" min="0"
                                            step="0.01" value="0" class="form-control">
                                    </div>
                                </div>

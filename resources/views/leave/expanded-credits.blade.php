                ...
                <div class="panel-heading">
                    ...
                    @if (Auth::check())
                        @if (Auth::user()->isAdmin())
                            ...
                            <a href="{{ url('leave') }}" class="pull-right btn btn-primary"><span
                                    class="fa fa-gear"></span>&nbsp;View Leave Lists</a>&nbsp;
                        @endif
                    @endif
                </div>
                        ...
                        <tbody>
                            @foreach ($employees as $employee)
                                <tr>
                                    ...
                                    @if (Auth::user()->isAdmin())
                                        <td>
                                            <a title="Adjust leave credits"
                                                href="{{ url('leave/credits') . '/' . $employee->id }}"><i
